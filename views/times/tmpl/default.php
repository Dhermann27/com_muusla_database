...
<div>This table is for the common timeslots of MUUSA events (Morning
Celebration, Afternoon Workshops, etc.)<br />
<b>NOTE: Start times should be listed in HH:MM AM format, and only at
00/15/30/45 minutes. Length should be duration, in hours (to the nearest
quarter).</b></div>
<form
...
<table class="blog" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<div class="article-content">New Name: <input type='text'
			name='timename-0' size='20' /></div>
		</td>
		<td>
		<div class="article-content">Start Time: <input type='text'
			name='timestart-0' size='10' value='9:50 AM' /></div>
		</td>
		<td>
		<div class="article-content">Length: <input type='text'
			name='timelength-0' size='5' value='2' /></div>
		</td>
		<td>&nbsp;</td>
