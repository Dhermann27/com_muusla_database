...
<div>This table is for creating events.<br />
<b>NOTE: Deleting a event will also delete all attendee records for that
event!</b></div>
<form
...
?>
	<tr>
		...
		<div class='article-content'>New Name: <input type='text'
			name='name-0' size='10' /> <select name='roomid-0'>
			<?php
			foreach($this->rooms as $room) {
		...
		Description: <input type='text' name='subname-0' size='25' />
		Capacity: <input type='text' name='capacity-0' size='5' /> Fee: $<input
		...
		?>
		</select> Days: Su <input type='checkbox' name='su-0' value='1' /> M <input
			type='checkbox' name='m-0' value='1' /> T <input type='checkbox'
			name='t-0' value='1' /> W <input type='checkbox' name='w-0' value='1' />
		Th <input type='checkbox' name='th-0' value='1' /> F <input
			type='checkbox' name='f-0' value='1' /> Sa <input type='checkbox'
			name='sa-0' value='1' /></div>
