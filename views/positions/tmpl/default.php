...
<div>This table is for positions that can be applied to campers for
duties performed (PC Member, Cratty Counselor, etc.) Use $999.00 to
cover all costs.<br />
<form
...
?>
	<tr>
		...
		<div class="article-content">New Name: <input type='text'
			name='positionname-0' size='20' /> Registration Amount: $<input
			type='text' name='positionregamount-0' size='10' value='0.00' />
		Housing Amount: $<input type='text' name='positionhouseamount-0'
			size='10' value='0.00' /> Shown on Form: <input type='checkbox'
			name='positionshown-0' value='1' /></div>
