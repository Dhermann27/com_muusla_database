...
<div>This table is to create rates for each building, program, and occupancy
level. 999 occupancy denotes 1 or more of adults or children in the room.</div>
<form
...
?>
	<tr>
		...
		<div class="article-content"><select name="ratebuildingid-0">
		<?php
		...
		?>
		</select> # Adults: <input type='text' name='rateoccadult-0' size='5' />
		# Children: <input type='text' name='rateoccchild-0' size='5' />
		Amount: $<input type='text' name='rateamount-0' size='10' value='0.00' /></div>
