            ...
            <td valign="top">
               <div>
                  ...
                  <div class="article-content">
                     ...
                     echo "               </select>\n";
		?>
                     New Number: <input type='text' name='roomnbr-0'
                        size='10' /> Capacity: <input type='text'
                        name='roomcapacity-0' size='5' /> Workshop? <input
                        type='checkbox' name='roomworkshop-0' value='1' />
                     Handicap? <input type='checkbox'
                        name='roomhandicap-0' value='1' />
                  </div>
